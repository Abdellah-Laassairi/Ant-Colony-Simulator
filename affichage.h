...
//     cette fonction doit être utilisée obligatoirement UNE SEULE FOIS, et avant toutes les autresle monde
...
void MiseAJourEnvironnement(const t_monde & environnement);
...
void MiseAJourPheromones(const t_matrice & pheromones);
